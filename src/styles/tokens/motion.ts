...
export const motionCurves: Record<MotionEase, [number, number, number, number]> = {
	linear: [0, 0, 1, 1],
...
export const motionPresets: MotionPreset[] = [
	...
	{ id: 'fade-in', duration: 0.4, ease: 'outExpo', offset: { y: 12 }, blur: true },
	{ id: 'orbit', duration: 3.4, ease: 'linear' },
	{ id: 'hero-lift', duration: 0.9, ease: 'outExpo', offset: { y: 28 }, blur: true },
	{ id: 'cascade', duration: 0.8, ease: 'outExpo', stagger: 0.06, offset: { y: 16 }, blur: true },
	{ id: 'chip', duration: 0.5, ease: 'outBack', offset: { y: 8 } },
	{ id: 'timeline', duration: 0.7, ease: 'inOutCubic', offset: { x: -10 }, blur: true }
];
