...
export const typographyScale: TypographyScale[] = [
	...
	{ label: 'display-lg', fontSize: 'clamp(2.5rem, 7vw, 4.5rem)', lineHeight: '1.05' },
	{ label: 'headline-md', fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', lineHeight: '1.2' },
	{ label: 'body-lg', fontSize: '1.125rem', lineHeight: '1.7' },
	{ label: 'detail-sm', fontSize: '0.875rem', lineHeight: '1.6', letterSpacing: '0.04em' }
];
