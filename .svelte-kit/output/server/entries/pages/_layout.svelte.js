import { c as create_ssr_component, a as createEventDispatcher, b as subscribe, d as add_attribute, e as each, v as validate_component, f as escape, o as onDestroy, n as null_to_empty } from "../../chunks/ssr.js";
...
const ThemeToggle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { theme = "studio-light" } = $$props;
  createEventDispatcher();
  if ($$props.theme === void 0 && $$bindings.theme && theme !== void 0) $$bindings.theme(theme);
  return `<button type="button" class="btn btn-ghost btn-circle btn-sm" aria-label="Toggle color theme" aria-live="polite"><span class="sr-only" data-svelte-h="svelte-ntgole">Toggle theme</span> ${theme === "studio-light" ? `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-4 6a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM4 9a1 1 0 100 2H3a1 1 0 110-2h1zm13 0a1 1 0 110 2h-1a1 1 0 110-2h1zM5.636 5.636a1 1 0 011.414 0L8.05 6.636a1 1 0 11-1.414 1.414L5.636 7.05a1 1 0 010-1.414zm9.9 9.9a1 1 0 011.414 1.414l-.999.999a1 1 0 11-1.414-1.414l.999-.999zM5.636 14.364a1 1 0 010 1.414l-.999.999a1 1 0 11-1.414-1.414l.999-.999a1 1 0 011.414 0zM15.95 5.636a1 1 0 010 1.414L14.95 8.05a1 1 0 11-1.414-1.414l.999-.999a1 1 0 011.414 0z"></path></svg>` : `${theme === "studio-dark" ? `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-secondary" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>` : `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-accent" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm6 0a1 1 0 011 1v1h1a1 1 0 010 2h-1v1a1 1 0 01-2 0V6h-1a1 1 0 010-2h1V3a1 1 0 011-1zM3.293 7.293a1 1 0 011.414 0L6 8.586l1.293-1.293a1 1 0 111.414 1.414L7.414 10l1.293 1.293a1 1 0 01-1.414 1.414L6 11.414l-1.293 1.293a1 1 0 01-1.414-1.414L4.586 10 3.293 8.707a1 1 0 010-1.414zM15 2a1 1 0 011 1v1h1a1 1 0 010 2h-1v1a1 1 0 01-2 0V6h-1a1 1 0 010-2h1V3a1 1 0 011-1zm-5 10a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0v-1h-1a1 1 0 110-2h1v-1a1 1 0 011-1z" clip-rule="evenodd"></path></svg>`}`}</button>`;
});
const GlobalNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.theme === void 0 && $$bindings.theme && theme !== void 0) $$bindings.theme(theme);
  $$unsubscribe_page();
  return `<div class="pointer-events-none fixed inset-x-0 top-6 z-50 flex justify-center px-4"><nav class="pointer-events-auto relative flex items-center gap-2 rounded-full border border-white/10 bg-base-100/60 p-2 shadow-glow backdrop-blur-surface transition-all duration-500 hover:scale-[1.01] hover:bg-base-100/80 supports-[backdrop-filter]:bg-base-100/40"${add_attribute("this", navElement, 0)}> <a href="/" class="group flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary to-secondary text-white shadow-lg transition-transform duration-300 hover:rotate-12" data-svelte-h="svelte-3mn7m7"><span class="font-display font-bold">M</span></a>  <div class="hidden items-center gap-1 px-4 md:flex">${each(navLinks, (link) => {
    return `<a${add_attribute("href", link.href, 0)} class="${"relative rounded-full px-4 py-2 text-sm font-medium transition-colors hover:bg-white/10 hover:text-primary " + escape(
      $page.url.pathname === link.href ? "bg-white/5 text-primary" : "text-base-content/80",
      true
    )}">${escape(link.label)} ${$page.url.pathname === link.href ? `<span class="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary"></span>` : ``} </a>`;
  })}</div>  <div class="flex items-center gap-2 pl-2"><a href="/contact" class="btn btn-ghost btn-circle btn-sm hidden sm:flex" aria-label="Contact" data-svelte-h="svelte-ure95h"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"></path></svg></a> ${validate_component(ThemeToggle, "ThemeToggle").$$render($$result, { theme }, {}, {})}  <button class="btn btn-ghost btn-circle btn-sm md:hidden" data-svelte-h="svelte-1qob9k"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg></button></div></nav></div>  ${``}`;
});
