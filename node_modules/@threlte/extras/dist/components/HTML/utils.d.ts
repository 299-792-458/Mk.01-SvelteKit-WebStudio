...
export declare const compileStyles: (styles: CSSStyleDeclaration) => string;
export declare const updateStyles: (store: Writable<Partial<CSSStyleDeclaration>>, styles: CSSStyleDeclaration) => void;
